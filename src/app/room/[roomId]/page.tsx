...
const Page = () => {
  ...
  return (
    <main className="flex flex-col h-screen max-h-screen overflow-hidden">
        ...
        <div className="flex items-center gap-4">
          <div className="flex felx-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                className="text-[10px] bg-zinc-800 hover:bg-zinc-700 px-2 
                py-0.5 rounded text-zinc-400
          ...
          <div className="flex flex-col">
            ...
            <span
              className={`text-sm font-bold flex flex-col items-center
                 gap-2 ${
      ...
      <div className="flex-1 overflow-y-auto p-4 space-p-4 scrollbar-thin">
          ...
          <div className="flex flex-col items-start" key={msg.id}>
            <div className="max-w-[80%] group">
              <div className="flex items-baseline gap-3 mb-1">
                <span
                  className={`text-sm font-bold ${msg.sender === username ? "text-green-500" : "text-blue-500"}`}
                >
           ...
           text-green-500 animate-pulse"
            ...
            <input
              ...
              className="w-full bg-black border border-zinc-800
               ...
               transition-colors text-zinc-100 placeholder:text-zinc-700 py-3 pl-8 pr-4 text-sm
               "
              type="text"
              value={input}
